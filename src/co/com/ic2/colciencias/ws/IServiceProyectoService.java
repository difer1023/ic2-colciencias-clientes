 ...
 * 
 */
@WebServiceClient(name = "IServiceProyectoService", targetNamespace = "http://ws.colciencias.ic2.com.co/", wsdlLocation = "http://10.8.0.4:8081/flujoProyecto?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://10.8.0.4:8081/flujoProyecto?wsdl");
